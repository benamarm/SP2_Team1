...
public class Event 
{
	...
	public Event (Opleiding opleiding, Adres adres, Date start, Date eind, Personeel aanmaker, int min, int max, int eventID,boolean status)
	{
		this.opleiding = opleiding;
		this.adres = adres;
	...
	public String toString (Opleiding opleiding, Date start, Date eind)
	{
		return "De opleiding " + opleiding + " zal plaatsvinden op " + start;
	}
