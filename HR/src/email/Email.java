...
public class Email {
	...
	public static void aanvraag(List<String> to, boolean goedgekeurd) {
		...
		try {
			...
			if(goedgekeurd==true) {
				...
				message.setText("Beste \n\n\nU krijgt deze mail omdat uw aanvraag is goedgekeurd.\n\n\nGelieve niet te antwoorden op deze mail.");
			}else if(goedgekeurd==false){
				message.setSubject("Afkeuring opleiding");
				message.setText("Beste \n\n\nU krijgt deze mail omdat uw aanvraag NIET is goedgekeurd.\n\n\nGelieve niet te antwoorden op deze mail.");
			}
			// send the message
			Transport.send(message);
			System.out.println("message sent successfully...");
