...
public class Event {
	...
	public Event(Opleiding opleiding, Adres adres, Date start, Date eind, Personeel aanmaker, int min, int max,
			int eventID) {
	...
	public String toString() {
		return "De opleiding " + opleiding.getTitel() + " zal plaatsvinden op " + startDatum.toString();
	}
