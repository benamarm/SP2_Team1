...
public class odata {
	...
	client = ClientBuilder.newClient();
	WebTarget target = client.target("http://services.odata.org/V2/Northwind/Northwind.svc/Employees('"+id+"')/Emails?$format=application/json;odata.metadata=none");
	String s=target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	client = ClientBuilder.newClient();
	WebTarget target = client.target("http://services.odata.org/V2/Northwind/Northwind.svc/Employees('"+id+"')/FirstName?$format=application/json;odata.metadata=none");
	String s=target.request(MediaType.APPLICATION_JSON).get(String.class);
	...
	client = ClientBuilder.newClient();
	WebTarget target = client.target("http://services.odata.org/V2/Northwind/Northwind.svc/Employees('"+id+"')/AddressInfo?$format=application/json;odata.metadata=none");
	String s= target.request(MediaType.APPLICATION_JSON).get(String.class);
	return s;
